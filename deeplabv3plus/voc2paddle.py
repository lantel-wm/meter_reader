...
data_path = '../datasets/meter_deep/'
train_img_path = '../datasets/meter_deep/images/train/'
val_img_path = '../datasets/meter_deep/images/val/'
train_seg_path = '../datasets/meter_deep/annotations/train/'
val_seg_path = '../datasets/meter_deep/annotations/val/'

voc_data_path = '../datasets/meter_deep_voc/'
voc_img_path = '../datasets/meter_deep_voc/JPEGImages/'
voc_seg_path = '../datasets/meter_deep_voc/SegmentationClass/'
voc_set_path = '../datasets/meter_deep_voc/ImageSets/Segmentation/'
